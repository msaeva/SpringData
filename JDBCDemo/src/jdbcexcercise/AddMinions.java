...
public class AddMinions {
    ...
    public static void main(String[] args) throws SQLException {
        ...
        final PreparedStatement insertIntoMinions_Villains = connection.prepareStatement(INSERT_INTO_MINIONS_VILLAINS);

        insertIntoMinions_Villains.setInt(1, lastMinionId);
        insertIntoMinions_Villains.setInt(2, villainId);
