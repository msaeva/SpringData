...
import com.example.softunigamestore.entities.dtos.UserRegisterDTO;
import com.example.softunigamestore.repositories.UserRepository;
import com.example.softunigamestore.entities.dtos.UserLoginDTO;
import org.modelmapper.ModelMapper;
import org.springframework.stereotype.Service;

import java.util.Optional;

import static com.example.softunigamestore.constants.Validations.USERNAME_OR_PASSWORD_NOT_VALID_MESSAGE;
...
public class UserServiceImpl implements UserService {
    ...
    public String registerUser(String[] args) {
        ...
        // shows how many entities there are in the table users
        ...
        Optional<User> firstByEmail = this.userRepository.findFirstByEmail(user.getEmail());
...
//            throw new IllegalArgumentException("Email already exists");
    ...
    public String loginUser(String[] args) {
        ...
        Optional<User> user = userRepository.findFirstByEmail(userLoginDTO.getEmail());
